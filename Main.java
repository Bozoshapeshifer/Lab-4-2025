...
public class Main {
    ...
    public static void main(String[] args) throws IOException, FunctionPointIndexOutOfBoundsException, InappropriateFunctionPointException, ClassNotFoundException {
        ...
        Exp exp = new Exp();
        FileWriter fw = new FileWriter(new File("C:\\Users\\Deaisiq\\Lab-4-2025\\out1.txt"));
        TabulatedFunction TabExp = TabulatedFunctions.tabulate(exp,0, 10, 11);
        TabulatedFunctions.writeTabulatedFunction(TabExp, fw);
        fw.close();

        FileReader fr = new FileReader(new File("C:\\Users\\Deaisiq\\Lab-4-2025\\out1.txt"));
        ...
        DataOutputStream out = new DataOutputStream(new FileOutputStream("C:\\Users\\Deaisiq\\Lab-4-2025\\out2.txt"));
        TabulatedFunction TabLn = TabulatedFunctions.tabulate(ln,1, 10, 11);
        TabulatedFunctions.outputTabulatedFunction(TabLn, out);
        out.close();

        DataInputStream in = new DataInputStream(new FileInputStream("C:\\Users\\Deaisiq\\Lab-4-2025\\out2.txt"));
...
for(int i = 0; i < TabLn.getPointsCount(); ++i) {
    ...
    System.out.printf("x=%.1f: Ln = %f \t ReadTabLn = %f \n",
        ...
        TabulatedFunction LogExp = TabulatedFunctions.tabulate(LE, 1, 10, 11);
        ObjectOutputStream oos = new ObjectOutputStream(new FileOutputStream("C:\\Users\\Deaisiq\\Lab-4-2025\\out3.txt"));
        oos.writeObject(LogExp);
        oos.close();

        ObjectInputStream ois = new ObjectInputStream(new FileInputStream("C:\\Users\\Deaisiq\\Lab-4-2025\\out3.txt"));
